#ifndef _MINIOS_X86_H
#define _MINIOS_X86_H
...
static __inline void cpuid2(uint32_t info, uint32_t xecx, uint32_t *ecxp);
static __inline uint64_t read_tsc(void) __attribute__((always_inline));
static __inline void io_delay(void) __attribute__((always_inline));
static __inline void cli() __attribute__((always_inline));
static __inline void sti() __attribute__((always_inline));
//static __inline int test_cpuid(void);
...
io_delay(void)
{
	__asm __volatile("nop;nop;nop;nop;nop;nop;");
}
...
static __inline void
cpuid2(uint32_t info, uint32_t xecx, uint32_t *ecxp)
{
	uint32_t ecx;
	asm volatile("cpuid"
		: "=c" (ecx)
